...
if __name__ == '__main__':
    ...
    ###
    parser.add_option('--tweak', '-w', dest='tweak_order', help='Order of distortion corrections')
    ###
    ...
    if opt.upload or opt.upload_url:
        ...
        if opt.scale_lower and opt.scale_upper:
            ...
            kwargs.update(scale_est=opt.scale_est,
                          ...
                          scale_type='ev')
        for key in ['scale_units', 'center_ra', 'center_dec', 'radius', 'downsample_factor','tweak_order',]:
