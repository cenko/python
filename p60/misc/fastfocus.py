...
######################################################################
# $Id: fastfocus.py,v 1.1 2008/12/01 20:45:57 p60 Exp p60 $ #
######################################################################
...
def fastfocus(inpat,prepfile=yes,endhow="never",endwhen="",
...
_parfile=pardir + "fastfocus.par"
t=iraf.IrafTaskFactory(taskname="fastfocus",
                       value=_parfile,function=fastfocus)
...
def main():
    ...
    print "Running fastfocus with inpat=%s" % inpat
    fastfocus(inpat,prepfile=prepfile,endhow=endhow,endwhen=endwhen)
    sys.exit(0)
